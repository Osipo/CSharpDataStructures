...
namespace CSharpDataStructures.Structures.Maps {
    public class LinkedDictionary<K,V> : IDictionary<K,V>, ICollection<KeyValuePair<K,V>>, IEnumerable<KeyValuePair<K,V>>, IEnumerable {
        ...
        public LinkedDictionary(){
            this._count = 0;
            this._entries = new CSharpDataStructures.Structures.Lists.LinkedList<KeyValuePair<K,V>>();
        ...
        public System.Collections.Generic.ICollection<K> Keys{
            get{
                CSharpDataStructures.Structures.Lists.LinkedList<K> lks = new CSharpDataStructures.Structures.Lists.LinkedList<K>();
                foreach(KeyValuePair<K,V> entry in _entries){
                    lks.Add(entry.Key);
                }
                return lks;
        ...
        public System.Collections.Generic.ICollection<V> Values {
            get{
                CSharpDataStructures.Structures.Lists.LinkedList<V> lks = new CSharpDataStructures.Structures.Lists.LinkedList<V>();
                foreach(KeyValuePair<K,V> entry in _entries){
                    lks.Add(entry.Value);
                }
                return lks;
