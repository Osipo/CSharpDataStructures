    ...
    public class NRVisitor<T> : IVisitor<T> {
        ...
        public void PreOrder(ITree<T> tree, Action<Node<T>> act = null){
            ...
            CSharpDataStructures.Structures.Lists.Stack<CSharpDataStructures.Structures.Trees.Node<T>> STACK = 
                new CSharpDataStructures.Structures.Lists.Stack<CSharpDataStructures.Structures.Trees.Node<T>>(tree.GetCount());
        ...
        public virtual void InOrder(ITree<T> tree,Action<Node<T>> act = null){
            ...
            CSharpDataStructures.Structures.Lists.Stack<CSharpDataStructures.Structures.Trees.Node<T>> STACK2 = 
                new CSharpDataStructures.Structures.Lists.Stack<CSharpDataStructures.Structures.Trees.Node<T>>(tree.GetCount());
